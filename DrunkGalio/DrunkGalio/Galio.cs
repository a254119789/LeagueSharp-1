...
namespace DrunkGalio
{
    ...
    internal class Galio
    {
        ...
        public static List<Tuple<Obj_AI_Hero, float, bool>> ChampionDamage = new List<Tuple<Obj_AI_Hero, float, bool>>();

        private static HitChance hc;

        private static readonly List<Obj_AI_Hero> EnemyList = HeroManager.Enemies.ToList();
        ...
        public static void Init()
        {
            ...
            {
                ChampionDamage.Add(new Tuple<Obj_AI_Hero, float, bool>(enemy, -1, false));
            }
        }
        ...
        {
            if (Utility.CountEnemiesInRange(SpellManager.Q.Range) < 1)
            {
                return;
            }
        ...
        private static void Combo()
        {
            ...
            var rTargets = Utility.CountEnemiesInRange(SpellManager.R.Range);
        ...
        private static void UpdateList()
        {
            ...
            {
                ChampionDamage[i] = new Tuple<Obj_AI_Hero, float, bool>(
                    EnemyList[i],
